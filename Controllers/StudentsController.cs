...
namespace StudentDeptMVC8.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var appDbContext = _context.Students.Include(s => s.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,DepartmentId")] Student student)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "Id", "DeptName", student.DepartmentId);
            return View(student);
        }
